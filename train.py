...
#model_name = 'edsr-10pic-12layer-3x3-64-Diamond'
#model_name = 'edsr-10pic-8layer-3x3-64-conference'
#model_name = 'edsr-10pic-8layer-5x5-64-Diamond'
...
#model_name = 'edsr-10pic-8layer-5x5-64-torus2'
#model_name = 'edsr-10pic-8layer-3x3-64-conference'
#model_name = 'edsr-10pic-8layer-3x3-64-box'
#model_name = 'edsr-10pic-8layer-5x5-64-box'
...
edsr = EDSR(num_layers = 8, kernel_size = [3, 3])
edsr.train(10000, cnt, dataset, model_name = model_name)
